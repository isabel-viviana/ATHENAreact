      ...
      {/*  CONTENIDO  */}
            <div className="main__content">
              ...
              <section className="card card--diagnostic">
                ...
                <p>
                  Basado en tus últimos 5 simulacros, tienes una excelente base en humanidades. 
                  Tu principal oportunidad de mejora está en 
                  <strong>Inglés (Tiempos verbales)</strong> y 
                  <strong>Matemáticas (Trigonometría).</strong> Si mejoras un 15% en estas áreas, 
                  tu puntaje global subirá aproximadamente 25 puntos.
                </p>
              </section>
