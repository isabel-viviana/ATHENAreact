  ...
  return (
    <>
      <header className="page-header">
                      ...
                      <a href="#" className="mark-read">Marcar todo como leído <i className="fas fa-check-double"></i></a>
                  </header>
                  ...
                  <div className="notifications-wrapper">
                      <section className="notif-group">
                          ...
                          <div className="notif-card red">
                              <span className="status-dot"></span>
                              <div className="icon-box"><i className="fas fa-fire"></i></div>
                              <div className="notif-info">
                                  <h3>Racha en peligro</h3>
                                  <p>¡No olvides practicar hoy para mantener tus 12 días!</p>
                      ...
                      <section className="notif-group">
                          ...
                          <div className="notif-card green">
                              <span className="status-dot"></span>
                              <div className="icon-box"><i className="fas fa-trophy"></i></div>
                              <div className="notif-info">
                      ...
                      <section className="notif-group">
                          ...
                          <div className="notif-card purple">
                              <span className="status-dot"></span>
                              <div className="icon-box"><i className="fas fa-medal"></i></div>
                              <div className="notif-info">
                                  <h3>¡Bien hecho!</h3>
                      ...
                      <section className="notif-group">
                          ...
                          <div className="notif-card gray">
                              <span className="status-dot"></span>
                              <div className="icon-box"><i className="far fa-star"></i></div>
                              <div className="notif-info">
                                  <h3>Plan Premium activado</h3>
                                  <p>Tu plan estará activo hasta el 12 de mayo de 2026.</p>
                                  <span className="time">Hace 5 días</span>
                              </div>
                          </div>
      
                          <div className="notif-card ai-special">
                              <div className="ai-avatar">
                                  <img src="https://via.placeholder.com/40" alt="IA Bot" />
                              </div>
                              <div className="notif-info">
                                  <p className="ai-msg">Sigue aprendiendo para alcanzar tus metas. <strong>¡Tú puedes! 💪</strong></p>
                              </div>
                          </div>
                      </section>
                  </div>
