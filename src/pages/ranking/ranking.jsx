...
const nationalRanking = [
  ...
  { position: 4, name: 'Ana Rodriguez', score: 308, region: 'Valle del Cauca' },
    ...
    <div className="ranking-page">
      <section className="page-header">
        <div className="page-header__info">
          <h1>Ranking ICFES</h1>
          <p>
            Consulta los mejores puntajes por departamento y el top nacional del examen ICFES. Este ranking muestra los resultados más recientes y el avance de las regiones con mejor desempeño.
          </p>
        </div>
      </section>
      ...
      <div className="ranking-grid">
        <article className="ranking-card">
          <span className="ranking-card__label">Mejor departamento</span>
          <div className="ranking-card__value">Bogotá D.C.</div>
          <p className="ranking-card__meta">Puntaje promedio ICFES de 309 +12 en la última evaluación.</p>
        </article>

        <article className="ranking-card">
          <span className="ranking-card__label">Puntaje nacional top</span>
          <div className="ranking-card__value">320 pts</div>
          <p className="ranking-card__meta">Mejor puntaje reportado por un estudiante en el ranking nacional.</p>
        </article>

        <article className="ranking-card">
          <span className="ranking-card__label">Promedio nacional</span>
          <div className="ranking-card__value">276 pts</div>
          <p className="ranking-card__meta">Promedio nacional aproximado calculado a partir de los resultados de las regiones top.</p>
        </article>
      </div>
      ...
      <div className="ranking-table-wrapper">
        <section className="table-card">
          ...
          <p>Los 10 departamentos con mayor puntaje promedio ICFES.</p>
          <table>
            <thead>
              <tr>
                <th>#</th>
            ...
            <tbody>
              {departmentRanking.map((item) => (
                <tr key={item.position}>
                  <td className="rank-number">{item.position}</td>
                  <td className="department-name">{item.name}</td>
                  <td>
        ...
        <section className="national-panel">
          <article className="national-card">
            ...
            <p className="national-card__subtitle">Puntaje más alto registrado en el ranking nacional ICFES.</p>
          </article>

          <article className="top-department">
            <div className="top-department__rank">#1 Departamento en rendimiento</div>
            <div className="top-department__name">Bogotá D.C.</div>
            <div className="top-department__meta">Promedio: 309 pts • +12 respecto a la última publicación.</div>
          </article>
