    ...
    <>
      <div className="main__content">
            ...
            <section className="result-card">
              ...
              <p>
                Aquí están tus resultados globales.
              </p>
              ...
              <div className="card">
                ...
                <div className="subject">
                  ...
                  <div className="subject__bar">
                    <div className="subject__fill green" style={{ width: '68%' }}></div>
                  </div>
                ...
                <div className="subject">
                  ...
                  <div className="subject__bar">
                    <div className="subject__fill red" style={{ width: '45%' }}></div>
                  </div>
                ...
                <div className="subject">
                  ...
                  <div className="subject__bar">
                    <div className="subject__fill yellow" style={{ width: '55%' }}></div>
                  </div>
                ...
                <div className="subject">
                  ...
                  <div className="subject__bar">
                    <div className="subject__fill blue" style={{ width: '72%' }}></div>
                  </div>
