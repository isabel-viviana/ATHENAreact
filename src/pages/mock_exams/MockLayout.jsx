...
const MockLayout = () => {
    ...
    return (
        <div className="mock-layout">
            <header className="mock-header" style={{ display: 'flex', gap: 12, alignItems: 'center', marginBottom: 16 }}>
                ...
                <div style={{ marginLeft: 'auto', display: 'flex', gap: 8, alignItems: 'center' }}>
                    <small>Timer: {Math.floor(timerSeconds / 60)}:{String(timerSeconds % 60).padStart(2, '0')}</small>
